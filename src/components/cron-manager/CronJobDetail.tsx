  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 gap-3 border-b border-primary-200 p-3 md:grid-cols-3">
        <div>
          <p className="text-xs text-primary-600 tabular-nums">Horario</p>
        ...
        <div>
          <p className="text-xs text-primary-600 tabular-nums">Última ejecución</p>
          ...
          <p className="mt-1 text-xs text-primary-600 tabular-nums">
            Duración: {formatDuration(job.lastRun?.durationMs)}
          </p>
        </div>
        <div>
      ...
      <div className="p-3">
        <div className="mb-2 flex items-center gap-2 text-xs text-primary-600 tabular-nums">
          ...
          <span>Historial de ejecuciones (últimas 10)</span>
        </div>
